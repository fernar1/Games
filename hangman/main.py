...
class MainAppJar:
    ...
    _tup_images = ("1.gif", "2.gif", "3.gif", "4.gif", "5.gif", "6.gif", "7.gif")
    ...
    def _word_sel(self, button):
        if self._hg.process_guess(button.lower()) == True:
            ...
            self._app.setImage("img_hangman", self._tup_images[self._hg.num_guess])
    ...
    def _init_gui(self):
        ...
        self._app.addLabel("lbl_word", " ".join(self._hg.lst_guess)).config(
            font="Helvetica 40"
        )
        ...
        self._app.buttons(["New Word", "Quit"], self._btn_ctrls_clicked, width=20)
